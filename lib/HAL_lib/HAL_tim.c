...
#if defined(TIM1)    
    #if defined(__MZ311)
        case TIM1_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM1); break;
    #else        
        case TIM1_BASE: exRCC_APB2PeriphReset(RCC_APB2ENR_TIM1); break;
    #endif
#endif
#if defined(TIM2)      
        case TIM2_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM2); break;
#endif
#if defined(TIM3)       
        case TIM3_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM3); break;
#endif
#if defined(TIM4) 
        case TIM4_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM4); break;
#endif
#if defined(TIM5)
        case TIM5_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM5); break;
#endif
#if defined(TIM6)        
        case TIM6_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM6); break;
#endif
#if defined(TIM7)       
        case TIM7_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM7); break;
#endif
#if defined(TIM8)
        case TIM8_BASE: exRCC_APB2PeriphReset(RCC_APB2ENR_TIM8); break;
#endif
#if defined(TIM14)
    #if defined(__MZ311)
        case TIM14_BASE: exRCC_APB1PeriphReset(RCC_APB1ENR_TIM14); break;
    #else        
        case TIM14_BASE: exRCC_APB2PeriphReset(RCC_APB2ENR_TIM14); break;
    #endif
#endif
#if defined(TIM16)        
        case TIM16_BASE: exRCC_APB2PeriphReset(RCC_APB2ENR_TIM16); break;
#endif
#if defined(TIM17)        
        case TIM17_BASE: exRCC_APB2PeriphReset(RCC_APB2ENR_TIM17); break;
#endif
        default: break;
    }
}
